...
import { countries } from 'app/utils/countriesNameAndPrefixPhone';
        ...
        >
          ...
          >
            {countryCode2 && layout === 'first' && (
              <Text style={[styles.codeText, { color: '#B8B8B8' }]}>{`+${countryCode2}`}</Text>
            )}
            <TextInput
              style={{ backgroundColor: 'black', color: '#B8B8B8', fontSize: 16 }}
